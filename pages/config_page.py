...
class RegPage(WebPage):
    ...
    email_or_mobile_phone_field = WebElement(xpath='//*[@id="page-right"]/div/div[1]/div/form/div[3]/div/div/input')
    password_field = WebElement(xpath='//*[@id="page-right"]/div/div[1]/div/form/div[4]/div[1]/div/input')
    password_confirmation_field = WebElement(xpath='//*[@id="page-right"]/div/div[1]/div/form/div[4]/div[2]/div/input')
